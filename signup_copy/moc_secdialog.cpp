...
QT_MOC_LITERAL(1, 10, 18), // "switchToMainWindow"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 21), // "on_sendButton_clicked"
QT_MOC_LITERAL(4, 52, 21) // "on_pushButton_clicked"

    },
    "SecDialog\0switchToMainWindow\0\0"
...
void SecDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecDialog::switchToMainWindow)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SecDialog::switchToMainWindow()
{
